...
$template->set("description", "Portfolios de gema arquitectura y construccion, gema , gema arquitectura, gema contruccion, arquitectos, contruccion" . TITULO);
$template->set("keywords", "Portfolios de Portfolios de gema arquitectura y construccion, gema , gema arquitectura, gema contruccion, arquitectos, contruccion" . TITULO);
